		...
		<c:when test='${NovelMember.mId != null && NovelMember.mId != "GodNovel" }'>
			<div class="join__big">  
				<div class="event_title">1:1 고객센터
					<span class="inquiry_subTitle"><a href="InquiryWrite">문의하기 |</a></span>
					<span class="inquiry_subTitle active"><a href="Inquiry">문의내역</a></span>
				</div> 
		...
		<c:when test='${NovelMember.mId != null && NovelMember.mId == "GodNovel" }'>
			<div class="join__big"> 
				<div class="event_title">1:1 고객센터
					...
					<span class="inquiry_subTitle"><a href="InquiryCompletionList">답변완료</a></span>
				</div>  
				<form action="InquiryGodWrite">
