...
public class ReportNovelReg implements ReportService {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		   ...
		   int res = new AdminDAO().reportNovel(dto);
		   ...
		   if(res != 0 ) {
			   ...
			   request.setAttribute("move", "/report/ReportNovelForm?target="+dto.getReportedBoard());			   
		   }
